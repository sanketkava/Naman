...
},
{
  ...
  shortDescription: "A Python-based tool for encrypting and decrypting files using AES encryption.",
  longDescription: "This File Encrypter & Decrypter, developed using Python and the PyCryptodome library, enables secure file encryption and decryption with AES-256. Key features include a user-friendly CLI for selecting files, secure key generation and management, support for batch file processing, and a simple interface for encrypting sensitive data and decrypting it with the correct key. Designed for educational purposes, it demonstrates cryptographic principles and secure data handling.",
  tags: ["Python", "PyCryptodome", "AES-256", "Encryption", "Decryption", "Cryptography", "File Security"],
  liveLink: "#",
  repoLink: "#"
},
{
...
},
{
  ...
  const filters = ["All", "Cyber Security" , "Web Development", "Mobile Development" ];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 text-gradient-personal" style={{fontFamily: "'Inter', sans-serif", fontWeight: 800}}>
            My <span className="text-accent-fg">Creations</span>
          </h1>
