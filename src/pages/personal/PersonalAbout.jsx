...
const PersonalAbout = () => {
  ...
  "Linux Security (CLI Basics)",
  "Risk Firewall Configuration and Management"
  ];

  const timelineEvents = [
    { year: "2022 - 2025", title: "BCA in web devlopment", institution: "Sutex bank college of computer application", description: "Completed a comprehensive Bachelor's degree, focusing on software engineering, database systems, network security, and cybersecurity principles. Building a strong theoretical and practical foundation in IT and secure development practices." },
    { year: "2023 - 2024", title: "AICHE & PT / Diploma in Hardware & Networking Engineering", institution: "Inspire cyber security", description: ""},
        ...
        <section className="grid md:grid-cols-2 gap-12 md:gap-16 mb-20 md:mb-28 items-center">
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80 group">
              ...
              <img
                alt="Naman Ghevariya - Professional Portrait with a tech background"
          ...
          >
            <h2 className="text-3xl md:text-4xl font-semibold mb-6 text-primary-fg" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 700 }}>
              Naman Ghevariya: <span className="text-accent-fg">Cyber Security Enthusiast</span>
            </h2>
            <p className="text-base text-primary-fg/80 mb-4 leading-relaxed" style={{ fontFamily: "'Inter', sans-serif" }}>
            Hello! I&apos;m Naman Ghevariya, a IT student (2022-2025) with a deep passion for cybersecurity and a strong foundation in building secure digital solutions. My academic journey and hands-on projects, such as web vulnerability scanners and file encryption tools, drive my commitment to protecting systems and data from cyber threats.
            </p>
            <p className="text-base text-primary-fg/80 mb-6 leading-relaxed" style={{ fontFamily: "'Inter', sans-serif" }}>
            As a cybersecurity enthusiast, I specialize in ethical hacking, network security, and vulnerability assessment, leveraging tools like OWASP ZAP, Wireshark, and Python. I combine my MERN stack and React Native expertise with secure coding practices to develop robust applications while actively enhancing my skills in threat detection and risk management in dynamic, challenging environments.
            </p>
            <div className="flex flex-wrap gap-3.5">
              {[
                { icon: <BookOpen className="h-4.5 w-4.5 mr-1.5" />, text: "BCA Candidate" },
