      ...
      <div className="container mx-auto px-4">
        <motion.header className="text-center mb-16 md:mb-20" variants={itemVariants}>
          ...
          <p className="text-lg md:text-xl text-primary-fg/80 max-w-3xl mx-auto leading-relaxed">
            I’m Naman Ghevariya, founder of RakshaStack. If you're interested in innovative digital solutions, cybersecurity strategies, or just want to collaborate on a project, you're in the right place.
          </p>
        </motion.header>
        ...
        <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-start">
            ...
            <div className="glassmorphism-card p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <a href="mailto:naman@rakshastack.com" className="ml-4 text-primary-fg/90 hover:text-accent-fg">naman@rakshastack.com</a>
                </div>
                <div className="flex items-center">
            ...
            <div className="glassmorphism-card p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="ml-4 text-primary-fg/80">Founder & CyberSecurity analyst at RakshaStack</span>
                </div>
                <div className="flex items-center">
                  <GraduationCap className="h-5 w-5 text-accent-fg" />
                  <span className="ml-4 text-primary-fg/80">Cyber security Expert</span>
                </div>
                <div className="flex items-center">
          ...
          <motion.div className="glassmorphism-card p-8 md:p-10 shadow-xl" variants={itemVariants}>
            ...
            <div className="mt-6">
              <a
                href="www.linkedin.com/in/naman-ghevariya"
                target="_blank"
